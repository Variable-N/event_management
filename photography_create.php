...
if (isset($_POST['register'])) {
    ...
    $Price = $_POST['Price'];
    $sql = "INSERT INTO `photo_cinema` (`id`, `owner`, `name`, `Services`, `Team Details`, `Location`, `Cinematography`, `contact`, `Price`)    VALUES ('$id', '$owner', '$tname', '$Services', '$Team_Details', '$Location', '$Cinematography', '$contact', '$Price')";    
...
<head>
    ...
    <title>Add Your photography Team</title>
    <style>
        body {
...
<body>
    ...
    <h1 align=center>
        <font style='color: #2200AA ; font-family: "Times New Roman"'> Add a new Photography and Cinematography Team</font>
        ...
        <div class="info-panel">
            <form method="POST">
                <div class="input-group">
                    <label for="Team_name">
                        <font color="#111166"><b>Team_Name:</b></font>
                    </label>
                ...
                <div class="input-group">
                    <lCinematography">
                        <font color="#111166"><b>Does this team provide Cinematography?:</b></font>
                    </label>
                    <input type="text" id="Cinematography" name="Cinematography" required>
                </div>
