...
<body>
    ...
    <h2 align=center>
        <div class="motto"> Select your venue as you desire </div>
    </h2>
    <div class="dashboard">
        <div class="info-container">
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="info-panel">';
                    echo '<h1>' . $row['name'] . '</h1>';
                    echo '<h2>Size: ' . $row['size'] . ' square feet</h2>';
                    echo '<h2>Capacity: ' . $row['capacity'] . ' person </h2>';
                    echo '<h3>Location: ' . $row['location'] . '</h3>';
                    echo 'Description: ' . $row['description'] . '<br>';
                    echo '<h2>Price: ' . $row['price'] . ' BDT </h2>';
                    echo '<br>';
                    echo '<a href="venuebook.php" class="btn btn-login button2">Book Now</a>';
                    echo '</div>';
                }
