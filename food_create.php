...
if (isset($_POST['register'])) {
    ...
    $Price = $_POST['Price'];
    $sql = "INSERT INTO `food_team` (`id`, `owner`, `name`, `services`, `Food Menu`, `location`, `coverage`, `contact`, `price`) VALUES ('$id', '$owner', '$fname', '$Services', '$Food_Menu', '$Location', '$coverage', '$contact', '$Price')";
...
<head>
    ...
    <title>Add Your Food Team</title>
    <style>
        body {
...
<body>
    ...
    <h1 align=center>
        <font style='color: #2200AA ; font-family: "Times New Roman"'> Add a new Food Team</font>
    ...
    <div class="dashboard">
        <div class="info-panel">
            <form method="POST">
                <div class="input-group">
                    <label for="Team_name">
                        <font color="#111166"><b>Provider Name:</b></font>
                    </label>
                    <input type="text" id="Team_name" name="food_name" required>
                </div>
                <div class="input-group">
                    <label for="services">
                ...
                <div class="input-group">
                    <label for="FoodMenu">
                        <font color="#111166"><b>Food Menu:</b></font>
                    </label>
                    <input type="text" id="FoodMenu" name="Food_Menu" required>
                </div>
                <div class="input-group">
                    <label for="Location">
        ...
        <div class="info-panel">
            ...
            <div class="input-group">
                <label for="Price">
                    <font color="#111166"><b>Estimated Price (Per 100 Person):</b></font>
                </label>
