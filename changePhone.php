...
if (isset($_POST['submit'])) {
    ...
    $nphone1 = $_POST['new_phone1'];
    $nphone2 = $_POST['new_phone2'];
    if ($nphone1 != $nphone2) {
        $output = "<h2> <font color = red> Unmatched phone number. Check your new phone numbers </font></h2>";
    } else if ($cpass == $pass && $cphone == $phone) {
        $sql = "UPDATE member SET contact = '$nphone1' WHERE username = '$uname' and password = '$cpass';";
        ...
        $output = "Wrong Phone Number or Password. Try again";
    }
}
...
<head>
    ...
    <title>Change Phone Number - EventM</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="input-group">
                <label for="username">
                    <font color="#707da4"><b>Enter your current phone number:</b></font>
                </label>
                <input type="text" id="username" name="phone">
            </div>
            <div class="input-group">
                <label for="username">
                    <font color="#707da4"><b>Enter your new phone number:</b></font>
                </label>
                <input type="text" id="username" name="new_phone1">
            </div>
            <div class="input-group">
                <label for="username">
                    <font color="#707da4"><b>Enter your new phone number again:</b></font>
                </label>
                <input type="text" id="username" name="new_phone2">
            </div>
            <div class="input-group">
                <label for="password">
            ...
            <button type="submit" name=submit class="btn btn-login">Update Phone number</button>
            <?php
            if ($_SESSION['type'] == 'C') { ?>
