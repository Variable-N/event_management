...
<head>
    ...
    <title>Regostration Sucessful - EventM</title>
    <style>
        body {
...
<body background="img\wp7488228.png">
    <div class="container">
        <h1>Registration Sucessful! <br><br> <br>  Welcome to <div class=" eventm"> EventM </div>
        </h1>
        <h2> Now you can login to EventM </h2><br> <br> 
        <a href="login.php" class="btn btn-login button2">Login</a>
