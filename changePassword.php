...
if (isset($_POST['submit'])) {
    ...
    if ($npass1 != $npass2) {
        $output = "Unmatched password. Check your new passwords";
    } else if ($cpass == $pass) {
        $sql = "UPDATE member SET password = '$npass1' WHERE username = '$uname' and password = '$cpass';";
...
<head>
    ...
    <title>Change Password - EventM</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="input-group">
                <label for="username">
                    <font color="#5b3a9a"><b>Enter your current password:</b></font>
                </label>
                <input type="password" id="username" name="pass" required>
            </div>
            <div class="input-group">
                <label for="username">
                    <font color="#5b3a9a"><b>Enter your new password:</b></font>
                </label>
                <input type="password" id="username" name="new_pass1" required>
            </div>
            <div class="input-group">
                <label for="username">
                    <font color="#5b3a9a"><b>Enter your new password again:</b></font>
                </label>
                <input type="password" id="username" name="new_pass2" required>
            </div>
            <button type="submit" name=submit class="btn btn-login">Update Password</button>
            <?php
            if ($_SESSION['type'] == 'C') { ?>
